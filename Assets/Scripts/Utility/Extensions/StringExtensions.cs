...
namespace Util.Extensions
{
    public static class StringExtensions
    {
        ...
        public static string ToSpriteTag(this string spriteName)
        {
            if (string.IsNullOrWhiteSpace(spriteName))
                return string.Empty;

            // Escape any double-quotes that might sneak in
            var safeName = spriteName.Replace("\"", "&quot;");
            return $"<sprite name=\"{safeName}\">";
        }
    }
}